  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span class="chosen-selected-span">' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input class="chosen-search-text" type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
      }
