    ...
    $.extend($.jqx._jqxGrid.prototype, {
        defineInstance: function () {
            var settings = {
                ...
                pagerheight: 20,		//pagerheight: 28,
                // sets the group header's height.
                groupsheaderheight: 30,
        ...
        createInstance: function (args) {
            ...
            var gridStructure = "<div class='jqx-clear jqx-border-reset jqx-overflow-hidden jqx-max-size jqx-position-relative'>" +
                ...
                "<div class='jqx-clear ' id='pager' style='z-index: 20;'></div>" +
                ...
                "<div class='jqx-clear jqx-overflow-hidden jqx-border-reset jqx-background-reset' id='content" + that.element.id + "'></div>" +
        ...
        _handlecolumnsmenu: function (self, columncontentcontainer, column, columnsmenu, columnitem) {
            ...
            var opencolumnsmenu = function () {
                ...
                if (filteritem != null) {
                    ...
                    var height = itemscount * 27;//2016-06-07		var height = itemscount * 27 + 3;
                    if ($.jqx.browser.msie && $.jqx.browser.version < 8) {
                        height += 20;
        ...
        _rendercolumnheader: function (text, align, headerheight, self) {
            ...
            if (self.columngroups) {
                margin = (headerheight / 2 - this._columnheight / 2); //2016-05-09		//margin = (headerheight / 2 - this._columnheight / 2);
                if (margin < 0) {
                    margin = 6;//4;
                }
                margin += 'px';
                ...
                if (this.columnsheight != 25) {
                    margin = (this.columnsheight / 2 - this._columnheight / 2);			//2016-05-09		//margin = (this.columnsheight / 2 - this._columnheight / 2);
                    if (margin < 0) {
                        margin = 6;//4;
                    }
                    margin += 'px';
        ...
        _defaultcellsrenderer: function (value, column) {
            ...
            if (this.rowsheight != 25) {
                margin = (this.rowsheight / 2 - this._cellheight / 2) ; //2016-05-09		//margin = (this.rowsheight / 2 - this._cellheight / 2);
                if (margin < 0) {
                    margin = 6;//4;
                }
                margin += 'px';
        ...
        _arrange: function () {
            ...
            var baseheight = function () {
                var height = 0;
                var columnheaderheight = me.showheader ? me.columnsheader != null ? me.columnsheader.height() : 0 : 0;		//2016-06-07 var columnheaderheight = me.showheader ? me.columnsheader != null ? me.columnsheader.height() + 2 : 0 : 0;
            ...
            if (me.showtoolbar) {
                ...
                //me.toolbar.css('top', me.pageheight+"px");
            ...
            if (me.hScrollBar[0].style.top != top + height - scrollOffset - scrollSize - pageheight + 'px' || me.hScrollBar[0].style.left != '0px') {
                ...
                me.hScrollBar.css({ top: top + height - scrollOffset - scrollSize + 'px', left: '0px' });
            }
            ...
            if (!me.autoheight) {
                ...
                if (me.vScrollBar[0].style.left != parseInt(width) - parseInt(scrollSize) - scrollOffset + 'px' || me.vScrollBar[0].style.top != top + 'px') {
                    ...
                    me.vScrollBar.css({ left: parseInt(width) - parseInt(scrollSize) - scrollOffset + 'px', top: top + pageheight });
                }
            }
            ...
            if (me.content[0].style.top != top + 'px') {
                me.content.css('top', top + me.pagerheight);
            }
            if (me.rtl) {
			...
			if(me.showtoolbar){
				me.toolbar.css('top',me.pagerheight);
			}
        ...
        _handlemousedown: function (event, self) {
            ...
            var x = left - hostoffset.left;
            var y = top - columnheaderheight - hostoffset.top - groupsheaderheight -pagerheight;
            if (this.pageable && !this.autoheight && this.gotopage) {
                var pagerposition = this.pager.coord().top - hostoffset.top - groupsheaderheight - columnheaderheight - pagerheight;
                if (y > pagerposition) {
                    return;
                }
            }
