...
(function ($) {
    ...
    $.extend($.jqx._jqxDateTimeInput.prototype, {
        ...
        render: function () {
            ...
            that.dateTimeInput = $("<input style='padding-left: 3px; padding-right: 3px;' class='jqx-position-absolute' id='" + "input" + that.element.id + "' autocomplete='off' type='textarea'/>").appendTo(wrapper);
