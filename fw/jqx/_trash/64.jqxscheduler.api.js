    ...
    $.extend($.jqx._jqxScheduler.prototype,
{
    ...
    initRepeatPanels: function (_editDialog, content, end) {
        ...
        var createBottomPanel = function (ownerPanel, panelType) {
            ...
            var neverRadioButton = $("<div style='position:relative; top: 6px; float:left;'><span style='margin-left:2px;'>" + that.schedulerLocalization.editDialogRepeatNeverString + "</span></div>").appendTo(field);
            ...
            var afterRadioButton = $("<div style='position:relative; top: 6px; float:left;'><span style='margin-left:2px;'>" + that.schedulerLocalization.editDialogRepeatAfterString + "</span></div>").appendTo(field2);
            ...
            var onRadioButton = $("<div style='position:relative; top: 6px; float:left;'><span style='margin-left:2px;'>" + that.schedulerLocalization.editDialogRepeatOnString + "</span></div>").appendTo(field3);
            onRadioButton.jqxRadioButton({ rtl: that.rtl, groupName: "end" + panelType, theme: that.theme, height: 25, checked: false });
            var onInput = $("<div style='margin-left: 3px; float:left;'></div>").appendTo(field3);
            onInput.jqxDateTimeInput({ rtl: that.rtl, localization: that._getDateTimeInputLocalization(), firstDayOfWeek: that.schedulerLocalization.firstDay, todayString: that.schedulerLocalization.todayString, clearString: that.schedulerLocalization.clearString, value: end, formatString: that.editDialogDateFormatString, height: 25, width: 150, theme: that.theme });
    ...
    _initMenu: function () {
        ...
        if (this.host.jqxMenu) {
            ...
            this.addHandler(this.menu, 'close', function (event) {
                ...
                that._hasOpenedMenu = false;
                if (document.activeElement && document.activeElement.className.indexOf('jqx-menu') >= 0) {
                    that.focus();
                }
        ...
        if (that._editDialog == null) {
            ...
            $(_editDialog).jqxWindow({
                ...
                autoFocus: false, autoOpen: false, animationType: "none", theme: that.theme, width: 530, maxHeight: 800, minHeight: 110, resizable: false, initContent: function () {
                    ...
                    var subjectInput = $("<input/>").appendTo(subjectField);
                    ...
                    var locationInput = $("<input/>").appendTo(locationField);
                    ...
                    fromInput.jqxDateTimeInput({ rtl: that.rtl, localization: that._getDateTimeInputLocalization(), firstDayOfWeek: that.schedulerLocalization.firstDay, todayString: that.schedulerLocalization.todayString, clearString: that.schedulerLocalization.clearString, value: fromInputDate, formatString: that.editDialogDateTimeFormatString, width: '100%', showTimeButton: true, height: 25, theme: that.theme });
                    ...
                    toInput.jqxDateTimeInput({ rtl: that.rtl, localization: that._getDateTimeInputLocalization(), firstDayOfWeek: that.schedulerLocalization.firstDay, todayString: that.schedulerLocalization.todayString, clearString: that.schedulerLocalization.clearString, value: toInputDate, formatString: that.editDialogDateTimeFormatString, width: '100%', showTimeButton: true, height: 25, theme: that.theme });
                    ...
                    var allDayInput = $("<div style='position:relative; top: 6px;'></div>").appendTo(allDayField);
                    ...
                    var descriptionInput = $("<textarea resizable='off' style='position:relative; top: 3px;'></textarea>").appendTo(descriptionField);
