    ...
    $.extend($.jqx._jqxKanban.prototype, {
        ...
        _addCSS: function () {
            ...
            if (that.verticalTextOrientation == "bottomToTop") {
                var iverteDcolumns = $("#" + that._kanbanId).find(".vertical-container");
                iverteDcolumns.removeClass('vertical-container');
                iverteDcolumns.addClass('vertical-container-inverse');
            }
        },
        ...
        _collapseColumn: function (columnNumber) { //add columnName as parameter
            ...
            if (that._ie8 || that._ie7) {
                $("#" + that._kanbanId + " .vertical-container").addClass(that.toThemeProperty("vertical-container-ie8-fix"));
                $("#" + that._kanbanId + " .vertical-container-inverse").addClass(that.toThemeProperty("vertical-container-inverse-ie8-fix"));
            }
        ...
        _removeEventHandlers: function () {
            ...
            that.removeHandler($(window), 'resize.kanben' + that.element.id);
