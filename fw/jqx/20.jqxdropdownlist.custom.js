    ...
    $.extend($.jqx._jqxDropDownList.prototype, {
        ...
        render: function () {
            ...
            try {
                ...
                var me = self;
                self.container.width(parseInt(width) + 2);
                self.container.height(parseInt(self.dropDownHeight) + 2);
        ...
        _setSize: function () {
            ...
            var resizeFunc = function () {
                ...
                if (me.dropDownWidth == 'auto') {
                    ...
                    me.container.width(parseInt(width) + 2);
                }
            }
            ...
            if (isPercentage) {
                ...
                this.container.width(parseInt(width) + 2);
            }
        ...
        showListBox: function () {
            ...
            if (this.dropDownHorizontalAlignment == 'right' || this.rtl) {
                ...
                if (containerWidth > this.host.width()) {
                    this.container.css('left', 2 + parseInt(Math.round(leftPos)) - containerLeftOffset + "px");
                }
                else this.container.css('left', 2 + parseInt(Math.round(leftPos)) + containerLeftOffset + "px");
            }
        ...
        propertyChangedHandler: function (object, key, oldvalue, value) {
            ...
            if (key == "autoDropDownHeight") {
                ...
                if (object.autoDropDownHeight) {
                    object.container.height(object.listBoxContainer.height() + 2);
                }
                else {
                    object.listBoxContainer.jqxListBox({ height: object.dropDownHeight });
                    object.container.height(parseInt(object.dropDownHeight) + 2);
                }
            ...
            if (key == "dropDownWidth" || key == "scrollBarSize") {
                ...
                object.container.width(parseInt(width) + 2);
            }
