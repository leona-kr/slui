//# sourceURL=blacklist_import_form.js
'use strict';

_SL.nmspc("blacklist").importForm = function(){

	var
	// Config 정의
	mCfg = {
		formId : '#formBlacklistImport',
		urlImport : gCONTEXT_PATH + "event/blacklist_import.do"
	},
...
$(function(){
	slapp.blacklist.importForm.init();
});