	...
	drawGrid = function($grid){
		...
		$grid.jqxGrid({
			...
			columns: [
				...
				{ text: '등록일', datafield: 'reg_dt', cellsalign:'center', width:'15%'}
			]
		});
...
$(function(){
	...
	$("#btnSettingAuth").click(function(){
		new ModalPopup(gCONTEXT_PATH + "system/auth_form.html",{height:520});
	});
	
	/*//내정보보기(임시)
	$("#btnuserInfo").click(function(){
		new ModalPopup(gCONTEXT_PATH + "main/main_simpleUserInfo.html",{
			width:450,
			height:580	
		});
	});*/
